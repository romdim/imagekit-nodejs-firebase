...
// Currently taken from here: https://github.com/imagekit-developer/imagekit-nodejs/issues/7
...
declare module "imagekit" {
  ...
  class ImageKit {
    ...
    public listFiles(
      listFilesOptions: ListFileOptions,
      callback: Callback<ListFileResponse>
    ): void;
    public listFiles(
      listFilesOptions: ListFileOptions
    ...
    public getFileMetadata(
      fileId: string,
      callback: Callback<FileMetadataResponse>
    ): void;
    ...
    public bulkDeleteFiles(
      fileIds: string[],
      callback: Callback<BulkDeleteFilesResponse, BulkDeleteFilesError>
    ): void;
    public bulkDeleteFiles(fileIds: string[]): Promise<BulkDeleteFilesResponse>;

    public purgeCache(
      fullUrl: string,
      callback: Callback<PurgeCacheResponse>
    ): void;
    public purgeCache(fullUrl: string): Promise<PurgeCacheResponse>;

    public getPurgeCacheStatus(
      cacheRequestId: string,
      callback: Callback<PurgeCacheStatusResponse>
    ): void;
    public getPurgeCacheStatus(
      cacheRequestId: string
    ): Promise<PurgeCacheStatusResponse>;
